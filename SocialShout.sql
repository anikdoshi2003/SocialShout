...
--
-- Host: localhost:8889
-- Generation Time: Sep 10, 2023 at 06:00 AM
...
--
CREATE DATABASE IF NOT EXISTS `socialshout` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `socialshout`;
...
CREATE TABLE `users` (
                         ...
                         `acc_status` int(11) NOT NULL DEFAULT '0' COMMENT '0- Not Verified,1- Active,2- blocked '
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `gender`, `email`, `username`, `password`, `profile_pic`, `created_at`, `updated_at`, `acc_status`) VALUES
                                                                                                                                                              ...
                                                                                                                                                              (19, 'test', 'test', 1, 'tilemu@lyft.live', 'test', '098f6bcd4621d373cade4e832627b4f6', 'default_profile.jpg', '2023-09-10 05:58:46', '2023-09-10 05:59:02', 1);
